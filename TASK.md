...
- TG-001 (persistent-buff subsystem) remains the strategic objective but is
  HIGH-risk; an RFC must be posted in TEAMGOALS.md before touching `combat.ts`.
  Tier-A items above are LOW-risk and should ship first.
