// ============================================================
// Locate Object — PHB p.256
//
// 2nd-level divination, 1-action casting time, range self,
// concentration (10 min). Components: V, S, M (forked twig).
//
// Effect: Describe or name an object that is familiar to you. You sense the
//         direction to the object's location, as long as it is within 1,000
//         feet of you. If the object is in motion, you learn the direction
//         of its movement.
//
// v1 status: OUT-OF-COMBAT — divination sense with no combat effect.
//   shouldCast always returns null. Monsters with Locate Object will never
...
export const metadata = {
  name: 'Locate Object', level: 2, school: 'divination', rangeFt: 0,
  concentration: true, castingTime: 'action',
  outOfCombat: true,                       // divination sense — no combat effect
  locateObjectOutOfCombatV1Implemented: true,  // stub: shouldCast always null
} as const;
