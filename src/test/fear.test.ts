...
const FEAR_ACTION: Action = { name: 'Fear', isMultiattack: false, attackType: 'save', reach: 5, range: { normal: 30, long: 30 }, hitBonus: null, damage: null, damageType: null, saveDC: 25, saveAbility: 'wis', isAoE: true, isControl: true, requiresConcentration: false, slotLevel: 3, costType: 'action', legendaryCost: 0, description: 'Fear' };
const FEAR_ACTION_LOW: Action = { ...FEAR_ACTION, saveDC: 5 };
...
function makeCaster(pos: any = { x: 0, y: 0, z: 0 }, a: Action = FEAR_ACTION) { return makeCombatant('wiz', { name: 'Caster', pos, actions: [a], resources: withSlots3(1) }); }
