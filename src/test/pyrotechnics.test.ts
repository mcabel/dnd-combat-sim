...
function withSlots2(remaining = 1): PlayerResources { return { spellSlots: { 2: { max: 2, remaining } } }; }
const PYRO_ACTION: Action = { name: 'Pyrotechnics', isMultiattack: false, attackType: 'save', reach: 5, range: { normal: 60, long: 60 }, hitBonus: null, damage: null, damageType: null, saveDC: 25, saveAbility: 'con', isAoE: true, isControl: true, requiresConcentration: false, slotLevel: 2, costType: 'action', legendaryCost: 0, description: 'Pyrotechnics' };
const PYRO_ACTION_LOW: Action = { ...PYRO_ACTION, saveDC: 5 };
...
function makeCaster(pos: any = { x: 0, y: 0, z: 0 }, a: Action = PYRO_ACTION) { return makeCombatant('wiz', { name: 'Caster', pos, actions: [a], resources: withSlots2(1) }); }
